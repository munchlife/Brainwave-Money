...
var attributesGeneSignalPathway = [ 'signalPathwayId', 'pheromone', 'geneId' ]; // Removed: pheromone, wavePheromoneExpiration, reinforcementWavePheromone, reinforcementWavePheromoneExpiration, optional, cellId, lifeId
...
router.post('/instance/signup', function(req, res) {
    ...
    metabolism.Cell.create(newCell).bind({})
        ...
        .then(function() {
            ...
            // signalPathwayId, pheromone, wavePheromoneExpiration, reinforcementWavePheromone, reinforcementWavePheromoneExpiration, optional, lifeId fields are defaults
...
router.post('/:id/allowPaymentGene/:geneId', function(req, res) {
    ...
    .spread(function(signalPathway, gene, cell) {
        if (signalPathway)
            ...
            throw new Blockages.NotFoundError('Gene not found');
        else if (gene.geneType & GeneType.ENUM.GENERAL.value === 0)
